...
const Posts = He.lazy(()=>import("../content/Posts.tsx")
);
function HomeDirectory({ url  }) {
    return He.createElement("div", null, He.createElement("section", null, He.createElement("p", null, "This website is rendered using React 18's new SSR architecture, without a framework!"), He.createElement("p", null, "Concurrent rendering is enabled so that HTML is streamed and hydration is intermittent."), He.createElement("p", null, "TODO: writeup")), He.createElement("section", null, He.createElement(He.Suspense, {
        fallback: He.createElement("div", null, "Loading...")
    }, He.createElement(Posts, {
        url: url
    }))));
}
const RESET_STYLE = `
...
function Page({ children  }) {
    return He.createElement("div", {
        className: "page"
    }, He.createElement("header", {
        className: "header"
    }, He.createElement("h2", null, "snen.dev's react 18 deno example"), He.createElement("nav", {
        className: "navbar"
    }, He.createElement("a", {
        href: "https://github.com/snendev/website"
    }, He.createElement(GithubIcon, null)))), He.createElement("main", {
        className: "main"
    }, children));
}
const Archive = He.lazy(()=>import("../content/Archive.tsx")
);
function Sidebar({ url  }) {
    return He.createElement("aside", {
        className: "sidebar"
    }, He.createElement(He.Suspense, {
        fallback: He.createElement("span", null, "...")
    }, He.createElement(Archive, {
        url: url
    })));
}
...
function App({ url  }) {
    return He.createElement(Html, {
        entrypoint: He.createElement(He.Fragment, null, He.createElement("link", {
            rel: "prefetch",
            href: "App.tsx"
        }), He.createElement("link", {
            rel: "prefetch",
            href: "deps.ts"
        }), He.createElement("script", {
            type: "module",
            dangerouslySetInnerHTML: {
                __html: HYDRATION_SCRIPT
            }
        }))
    }, He.createElement(Page, null, He.createElement(Sidebar, {
        url: url
    }), He.createElement(HomeDirectory, {
        url: url
    })));
}
